      ...
      {activeView === 'clues' && (
        <article className="murdle-case-document">
          ...
          <button
            ...
            className="detective-notebook-launch"
            aria-label="เปิดสมุดนักสืบ"
            title="เปิดสมุดนักสืบ"
          >
            <span className="detective-notebook-launch-icon">
              <i className="fa-sharp fa-solid fa-book-open" aria-hidden="true"></i>
            </span>
          </button>
        </article>
      )}
